...
public:
	...
	void setBackgroundColor(float* new_color) { screen_background_color = lm::vec4(new_color[0], new_color[1], new_color[2], new_color[3]);  };
	...
	void setEnvironmentVisibility(bool state) { environmentVisible = state; };
